...
import mobileVideo from "../../assets/Goku.mp4"; 
import './cards.css';



const Goku = (props) => {
  const personInfo = Cards.find(card => card.titulo === 'Goku');

  if (!personInfo) {
    return <div>Não foi possível encontrar informações sobre o Goku.</div>;
  }
