...
import mobileVideo from "../../assets/Capitão Patria.mp4"; 
import './cards.css';



const Homelander = (props) => {
  const personInfo = Cards.find(card => card.titulo === 'Homelander');

  if (!personInfo) {
    return <div>Não foi possível encontrar informações sobre o Homelander.</div>;
  }
