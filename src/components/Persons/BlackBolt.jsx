...
import mobileVideo from "../../assets/BlackBolt.mp4"; 
import './cards.css';



const BlackBolt = (props) => {
  const personInfo = Cards.find(card => card.titulo === 'Black Bolt');

  if (!personInfo) {
    return <div>Não foi possível encontrar informações sobre o Black Bolt.</div>;
  }
