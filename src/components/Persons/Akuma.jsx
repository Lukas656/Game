...
import mobileVideo from "../../assets/Akuma.mp4"; 
import './cards.css';



const Akuma = (props) => {
  const personInfo = Cards.find(card => card.titulo === 'Akuma / Gouki ');

  if (!personInfo) {
    return <div>Não foi possível encontrar informações sobre o Akuma.</div>;
  }
