...
import mobileVideo from "../../assets/Atrocitus.mp4"; 
import './cards.css';



const Atrocitus = (props) => {
  const personInfo = Cards.find(card => card.titulo === 'Atrocitus');

  if (!personInfo) {
    return <div>Não foi possível encontrar informações sobre o Atrocitus.</div>;
  }
