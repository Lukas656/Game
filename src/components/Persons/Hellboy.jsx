...
import mobileVideo from "../../assets/Hellboy.mp4"; 
import './cards.css';



const Hellboy = (props) => {
  const personInfo = Cards.find(card => card.titulo === 'Hellboy');

  if (!personInfo) {
    return <div>Não foi possível encontrar informações sobre o Hellboy.</div>;
  }
