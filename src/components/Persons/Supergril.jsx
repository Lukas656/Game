...
import mobileVideo from "../../assets/Super Gril.mp4"; 
import './cards.css';



const SuperGril = (props) => {
  const personInfo = Cards.find(card => card.titulo === 'Super Gril');

  if (!personInfo) {
    return <div>Não foi possível encontrar informações sobre o Super Gril.</div>;
  }
