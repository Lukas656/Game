...
import mobileVideo from "../../assets/Omini Man.mp4"; 
import './cards.css';



const OminiMan = (props) => {
  const personInfo = Cards.find(card => card.titulo === 'Omini Man');

  if (!personInfo) {
    return <div>Não foi possível encontrar informações sobre o Omini Man.</div>;
  }
