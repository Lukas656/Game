...
import mobileVideo from "../../assets/Coringa.mp4"; 
import './cards.css';



const Coringa = (props) => {
  const personInfo = Cards.find(card => card.titulo === 'Coringa');

  if (!personInfo) {
    return <div>Não foi possível encontrar informações sobre o Coringa.</div>;
  }
